...
public class SignIn implements Screen {
    ...
    public void show() {
        ...
        background = new Texture("level_screen.png");     // CHANGE TO REAL PIC LATER

        // Login button
        login_image = new Texture("play_button.png");                       // CHANGE LATER
        ...
        // Sign Up button
        signUp_image = new Texture("quit_button.png");                          // CHANGE LATER
        signUp_button = new ImageButton(new TextureRegionDrawable(signUp_image));
        signUp_button.setPosition(270, 165);
        ...
        password_field.setPosition(270, 165);
