...
public class VictoryScreen implements Screen {
    ...
    private int existing_level;
    private World world;

    public VictoryScreen(MainGame game, Player player, Slingshot slingshot, int level) {
        this.game = game;
