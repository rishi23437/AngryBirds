...
//
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.ENTER)) {
            ...
            if(current_player.getLevels_cleared()<4){
                current_player.setLevels_cleared(4);
            }
            game.setScreen(new VictoryScreen(game, current_player, slingshot, 4));
            return;
        }

        if (Gdx.input.isKeyJustPressed(Input.Keys.SPACE)) {
            // set the screen to LostScreen
            game.setScreen(new LostScreen(game, current_player, slingshot, 4));
        }
    ...
    public void setPigs() {
        ...
        for(int i=1 ; i<=4; ++i ){
            ...
            switch(randomNumber2){
                case 1:this.pigs.add(new Pig("Level_1images/kingpig.png", 15)); break;
                case 2:this.pigs.add(new Pig("taupig.png", 12));break;
                case 3:this.pigs.add(new Pig("helmetpig.png", 18)); break;
                default:break;
            }
            temp_pig=pigs.getLast(); temp_pig.create(world, (430+(40)*i), 255);
        }
    ...
    private void setBlocks() {
        for(int i=0 ; i<=4; ++i ){
            ...
            for(int j =0; j<randomNumber1; ++j){
                ...
                temp_block=blocks.getLast(); temp_block.create(world, (430+(40)*i), (55+(40)*j), 35, 35);
            }
        }
    }
